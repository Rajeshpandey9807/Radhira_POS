...
public sealed class DatabaseInitializer
{
    ...
    public async Task InitializeAsync(CancellationToken cancellationToken = default)
    {
        ...
        var sqlCommands = new[]
        {
            ...
            "CREATE TABLE IF NOT EXISTS BusinessTypes (BusinessTypeId TEXT PRIMARY KEY, BusinessTypeName TEXT NOT NULL UNIQUE, IsActive INTEGER NOT NULL DEFAULT 1, CreatedBy TEXT NOT NULL, CreatedOn TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, UpdatedBy TEXT NULL, UpdatedOn TEXT NULL);",
