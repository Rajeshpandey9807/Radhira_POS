...
public sealed class DatabaseInitializer
{
    ...
    public async Task InitializeAsync(CancellationToken cancellationToken = default)
    {
        ...
        var sqlCommands = new[]
        {
            ...
            "CREATE TABLE IF NOT EXISTS BusinessTypes (Id TEXT PRIMARY KEY, IndustryTypeName TEXT NOT NULL UNIQUE, IsActive INTEGER NOT NULL DEFAULT 1, CreatedAt TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, UpdatedAt TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP);",
